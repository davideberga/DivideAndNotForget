...
if __name__ == "__main__":
    ...
    train_loader = get_data_for_classes(desired_classes, food101_train)#cifar10_train)
    test_loader = get_data_for_classes(desired_classes,  food101_test)#cifar10_test)
